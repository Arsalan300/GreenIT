...
?>
  ...
  <!-- <section class="my-5 py-5 ms-2" id="search">
    ...
    <form method="POST" action="shop.php" >
        <div class="row mx-auto container">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="form-check">
                    <input type="radio" value="damage jeans" class="form-check-input" name="category" id="category_three" checked>
                    <label for="flexRadioDefault3" class="form-check-label">Damage Jeans</label>
                </div>
